...
default:
	rm -rf bin
	mkdir bin
	${CC} src/main.cpp src/wavetables.cpp src/Component.cpp src/connect.cpp src/utils/ordinal.cpp src/play.cpp src/TypedSignalBuffer.cpp src/programs/goBoop.cpp src/components/**.cpp ${FLAGS} -o bin/play
