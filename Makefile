...
default:
	rm -rf bin
	mkdir bin
	${CC} src/main.cpp src/wavetables.cpp src/AudioProcess.cpp src/connect.cpp src/utils/ordinal.cpp src/play.cpp src/TypedSignalBuffer.cpp src/programs/goBoop.cpp ${FLAGS} -o bin/play
